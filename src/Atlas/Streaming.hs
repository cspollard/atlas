...
-- addFiles
--   :: Applicative m
--   => (Int, Sum Double, VarsT m (Folder YodaObj))
--   -> (Int, Sum Double, VarsT m (Folder YodaObj))
--   -> Either String (Int, Sum Double, VarsT m (Folder YodaObj))
...
--
-- encodeFile :: String -> (Int, Sum Double, VarsT IO (Folder YodaObj)) -> IO ()
...
--   :: Maybe String
--   -> String
--   -> IO (Either String (Int, Sum Double, Folder (VarsT m YodaObj)))
...
--   => Maybe String
--   -> f String
--   -> IO (Either String (IM.IntMap (Sum Double, Folder (VarsT m YodaObj))))
